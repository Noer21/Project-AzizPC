...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__provider_data__ = __webpack_require__(25);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__provider_data__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ionic_angular__ = __webpack_require__(11);
...
var AddrepairPage = (function () {
    function AddrepairPage(alertCtrl, camera, navCtrl, navParams, loadCtrl, http, data, toastCtrl) {
        var _this = this;
        this.alertCtrl = alertCtrl;
        this.camera = camera;
        this.navCtrl = navCtrl;
    ...
    AddrepairPage.prototype.repair = function (form) {
        var _this = this;
        this.submitted = true;
        var loading = this.loadCtrl.create({
            content: 'Tunggu sebentar...'
        ...
        if (form.valid) {
            ...
            this.http.post(this.data.link_local + "addRepair.php", input).subscribe(function (data) {
                ...
                _this.showAlert1(response.message);
            }, function (err) {
                loading.dismiss();
                _this.showError(err);
            });
    ...
    AddrepairPage.prototype.showError = function (err) {
        err.status == 0 ?
    ...
    AddrepairPage.prototype.showAlert1 = function (message) {
        var toast = this.toastCtrl.create({
            message: message,
            duration: 3000
        });
    ...
    AddrepairPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["m" /* Component */])({
            selector: 'page-addrepair',template:/*ion-inline-start:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\addrepair\addrepair.html"*/'<!--\n\n  Generated template for the AddrepairPage page.\n\n\n\n  See http://ionicframework.com/docs/components/#navigation for more info on\n\n  Ionic pages and navigation.\n\n-->\n\n<ion-header>\n\n\n\n  <ion-navbar>\n\n    <ion-title>Tambah Servis</ion-title>\n\n  </ion-navbar>\n\n\n\n</ion-header>\n\n\n\n\n\n<ion-content padding>\n\n    <form #repairForm="ngForm" novalidate>        \n\n          <ion-list>\n\n            <h5 class="head">Nama Barang</h5>\n\n            <ion-item>\n\n              <ion-input type="text" [(ngModel)]="namaBarang"  [ngModelOptions]="{standalone: true}"placeholder="Ex. Laptop Asus ROG Gx600"></ion-input>\n\n            </ion-item>\n\n\n\n            <h5 class="head">Keluhan</h5>\n\n            <ion-item>\n\n              <ion-textarea [(ngModel)]="keluhan"  [ngModelOptions]="{standalone: true}" placeholder="Keluhan Ananda"></ion-textarea>\n\n            </ion-item>\n\n\n\n            <h5 class="head"> Kelengkapan Barang</h5>\n\n            <ion-list>\n\n              <ion-item>\n\n                <ion-label>Charger</ion-label>\n\n                <ion-checkbox [(ngModel)]="charger" value="charger" [ngModelOptions]="{standalone: true}"></ion-checkbox>\n\n              </ion-item>\n\n              <ion-item>\n\n                <ion-label>Maouse</ion-label>\n\n                <ion-checkbox [(ngModel)]="mouse" value="mouse"[ngModelOptions]="{standalone: true}"></ion-checkbox>\n\n              </ion-item>\n\n              <ion-item>\n\n                <ion-label>Tas</ion-label>\n\n                <ion-checkbox [(ngModel)]="mushrooms" value="mushrooms" [ngModelOptions]="{standalone: true}"></ion-checkbox>\n\n              </ion-item>\n\n              <ion-item>\n\n                <ion-label>CD/Driver</ion-label>\n\n                <ion-checkbox [(ngModel)]="cd" value="cd" [ngModelOptions]="{standalone: true}"></ion-checkbox>\n\n              </ion-item>\n\n            </ion-list>\n\n\n\n            <h5 class="head">Jenis Servis </h5>\n\n            <ion-item>\n\n                <ion-label>Jenis Service</ion-label>\n\n                <ion-select [(ngModel)]="service" [ngModelOptions]="{standalone: true}" multiple="true">\n\n                  <ion-option value="Install Ulang">Install Ulang OS</ion-option>\n\n                  <ion-option value="HDD Bad Sector">HDD Bad Sector</ion-option>\n\n                  <ion-option value="Recovery">Recovery Data</ion-option>\n\n                  <ion-option value="Ganti LCD">Ganti HDD/LED/LCD</ion-option>\n\n                  <ion-option value="Upgrade Memory">Upgrade Memory</ion-option>\n\n                  <ion-option value="Mati Total">Mati Total</ion-option>\n\n                  <ion-option value="Blue Screen">Blue Screen</ion-option>\n\n                  <ion-option value="Membersihkan Laptop">Membersihkan Laptop/NB/PC</ion-option>\n\n                  <ion-option value="Ganti Fan">Ganti Fan</ion-option>\n\n                  <ion-option value="Ganti Mainboard">Ganti Mainboard/Keybiard/Casing</ion-option>\n\n                  <ion-option value="Service Panggilan">Service Panggilan</ion-option>\n\n                </ion-select>\n\n              </ion-item>\n\n\n\n              <h5 class="head">Alamat Penjemputan</h5>\n\n              <ion-item>\n\n                <ion-input type="text" [(ngModel)]="alamat"  [ngModelOptions]="{standalone: true}" placeholder="Ex. IPB dramaga"></ion-input>\n\n              </ion-item>\n\n\n\n              <h5 class="head">Unggah Foto Barang</h5>\n\n              <button ion-button icon-left (click)="takePhoto()">\n\n                <ion-icon name="camera"></ion-icon>\n\n                Ambil Foto\n\n              </button>\n\n          </ion-list>\n\n          <button (click)="repair(repairForm)" ion-button full>Submit</button>\n\n    </form>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\addrepair\addrepair.html"*/,
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["a" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["a" /* AlertController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__["a" /* Camera */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__ionic_native_camera__["a" /* Camera */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["i" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["i" /* NavController */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["j" /* NavParams */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["j" /* NavParams */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["g" /* LoadingController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["g" /* LoadingController */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_5__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_5__angular_http__["a" /* Http */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_1__provider_data__["a" /* Data */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__provider_data__["a" /* Data */]) === "function" && _g || Object, typeof (_h = typeof __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["l" /* ToastController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["l" /* ToastController */]) === "function" && _h || Object])
    ], AddrepairPage);
...
var ServicePage = (function () {
    ...
    ServicePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-service',template:/*ion-inline-start:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\service\service.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Service</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n\n\n<ion-content>\n\n  <ion-slides pager>\n\n    <ion-slide style="background-color: green">\n\n      <h2>Slide 1</h2>\n\n    </ion-slide>\n\n    <ion-slide style="background-color: blue">\n\n      <h2>Slide 2</h2>\n\n    </ion-slide>\n\n    <ion-slide style="background-color: red">\n\n      <h2>Slide 3</h2>\n\n    </ion-slide>\n\n  </ion-slides>\n\n  <div padding>\n\n    <h2> Ulasan kami : </h2>\n\n    <ion-list>\n\n      <ion-item>\n\n        <ion-avatar item-start>\n\n          <img src="assets/imgs/avatar-cher.jpg" />\n\n        </ion-avatar>\n\n        <h2>Raja Nusantara</h2>\n\n        <p>Hebat! saya kasih indoeskrim 1 truk</p>\n\n      </ion-item>\n\n      <ion-item>\n\n        <ion-avatar item-start>\n\n          <img src="assets/imgs/avatar-cher.jpg" />\n\n        </ion-avatar>\n\n        <h2>Awkarin</h2>\n\n        <p>Akhirnya saya bisa nge vlog lagi terima kasih Aziz PC</p>\n\n      </ion-item>\n\n    </ion-list>\n\n  </div>  \n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\service\service.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* NavParams */]])
    ], ServicePage);
    return ServicePage;
...
var AboutPage = (function () {
    ...
    AboutPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-about',template:/*ion-inline-start:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\about\about.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>\n\n      About\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\about\about.html"*/
        }),
...
var ContactPage = (function () {
    ...
    ContactPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-contact',template:/*ion-inline-start:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\contact\contact.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <ion-title>\n\n      Contact\n\n    </ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content>\n\n  <ion-list>\n\n    <ion-list-header>Follow us on Twitter</ion-list-header>\n\n    <ion-item>\n\n      <ion-icon name="ionic" item-start></ion-icon>\n\n      @ionicframework\n\n    </ion-item>\n\n  </ion-list>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\contact\contact.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavController */]])
    ], ContactPage);
    return ContactPage;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__angular_http__ = __webpack_require__(31);
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\app\app.html"*/'<ion-menu [content]="content">\n\n    <ion-header>\n\n        <ion-toolbar>\n\n            <ion-title>\n\n                Menu\n\n            </ion-title>\n\n        </ion-toolbar>\n\n    </ion-header>\n\n    <ion-content>\n\n        <ion-list>\n\n          <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n\n            {{p.title}}\n\n          </button>\n\n        </ion-list>\n\n      </ion-content>\n\n</ion-menu>\n\n\n\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>\n\n'/*ion-inline-end:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\app\app.html"*/
        }),
...
var TabsPage = (function () {
    ...
    TabsPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\tabs\tabs.html"*/'<ion-tabs>\n\n  <ion-tab [root]="tab1Root" tabTitle="Home" tabIcon="home"></ion-tab>\n\n  <ion-tab [root]="tab2Root" tabTitle="About" tabIcon="information-circle"></ion-tab>\n\n  <ion-tab [root]="tab3Root" tabTitle="Contact" tabIcon="contacts"></ion-tab>\n\n</ion-tabs>\n\n'/*ion-inline-end:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\tabs\tabs.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__detail_detail__ = __webpack_require__(162);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__addrepair_addrepair__ = __webpack_require__(163);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var HomePage = (function () {
    function HomePage(navCtrl, http, data, loadCtrl) {
        this.navCtrl = navCtrl;
        this.http = http;
        this.data = data;
        this.loadCtrl = loadCtrl;
    ...
    HomePage.prototype.add = function () {
        this.navCtrl.push(__WEBPACK_IMPORTED_MODULE_5__addrepair_addrepair__["a" /* AddrepairPage */]);
    };
    ...
    HomePage.prototype.binding = function () {
        var _this = this;
        this.data.getData().then(function (data) {
            _this.dataku = data;
            _this.id = _this.dataku.id;
            _this.servisan = [];
            for (var i = 0, j = 0; i < _this.datas.length; i++) {
                if (_this.id == _this.datas[i].customer_id) {
                    _this.servisan[j] = _this.datas[i];
                    j++;
                }
            }
        });
    ...
    HomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_2__angular_core__["m" /* Component */])({
            selector: 'page-home',template:/*ion-inline-start:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\home\home.html"*/'<ion-header>\n\n  <ion-navbar>\n\n    <button ion-button menuToggle>\n\n      <ion-icon name="menu"></ion-icon>\n\n    </button>\n\n    <ion-title>Home</ion-title>\n\n  </ion-navbar>\n\n</ion-header>\n\n\n\n<ion-content padding>\n\n  <ion-card *ngFor="let data of servisan">\n\n    <img src="assets/imgs/LogoAzizPC.jpg"/>\n\n      <ion-card-content>\n\n        <ion-card-title>\n\n          {{data.namaBarang}}\n\n        </ion-card-title>\n\n          <p class="Status"> Status: Diagnosa</p>\n\n          <h3 class="Link">\n\n            <a (click)="detail()"> Detail </a>\n\n          </h3>\n\n           \n\n      </ion-card-content>\n\n  </ion-card>\n\n  <!-- <ion-card>\n\n      <img src="assets/imgs/rusak.jpeg"/>\n\n        <ion-card-content>\n\n          <ion-card-title>\n\n            RoG Strix\n\n          </ion-card-title>\n\n            <p>\n\n              The most popular industrial group ever, and largely\n\n              responsible for bringing the music to a mass audience.\n\n            </p>\n\n        </ion-card-content>\n\n    </ion-card> -->\n\n    <ion-fab right bottom>\n\n      <button ion-fab color="light" (click)="add()"><ion-icon name="add"></ion-icon></button>\n\n    </ion-fab>\n\n</ion-content>\n\n'/*ion-inline-end:"C:\Users\asus\Documents\GitHub\Project-AzizPC\src\pages\home\home.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["i" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["i" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_0__provider_data__["a" /* Data */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__provider_data__["a" /* Data */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["g" /* LoadingController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3_ionic_angular__["g" /* LoadingController */]) === "function" && _d || Object])
    ], HomePage);
    return HomePage;
    var _a, _b, _c, _d;
}());
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_ionic_angular__ = __webpack_require__(11);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__provider_data__ = __webpack_require__(25);
